  ...
  return (
      <>
        <div className="relative w-screen h-[70vh] md:h-[85vh] flex items-center justify-center overflow-hidden pb-16">
          ...
          <div className="pointer-events-none absolute left-0 top-0 h-full w-[20vw] z-30" style={{
            background: "linear-gradient(to right, #18181b 0%, rgba(24,24,27,0.80) 60%, rgba(24,24,27,0.00) 70%)"
          }}></div>
          <div className="pointer-events-none absolute right-0 top-0 h-full w-[20vw] z-30" style={{
          ...
          <div className="relative z-20 text-center w-full max-w-3xl mx-auto px-6 flex flex-col items-center justify-center text-white">
            ...
            <p className="drop-shadow-[0_0_12px_rgba(0,0,0,0.85)] text-xl mb-2">Welcome to Your Fitness Hub <span className="text-red-400">💥</span></p>
            <p className="drop-shadow-[0_0_12px_rgba(0,0,0,0.85)] text-lg text-gray-300 mb-6">
              Track workouts. Monitor progress. Smash goals. <br />
              Everything you need to stay on top of your training — all in one place.
            </p>
            <p className="text-lg text-gray-300 mb-10 drop-shadow-[0_0_12px_rgba(0,0,0,0.85)]">Let’s level up. One workout at a time.</p>
            <div className="mt-12 text-white text-5xl drop-shadow-[0_0_12px_rgba(0,0,0,0.85)] animate-bounce">
              ↓
            </div>
          </div>
        </div>

        <div className="min-h-screen bg-[#18181b] text-white px-6 py-12">
